"""讨论会话自动存储（从 lifee.sessions.debate_store 适配）

当前未直接接入 FastAPI API，仅保留为后续多轮辩论模式预留。
"""
...
from backend.providers.base import Message, MessageRole
